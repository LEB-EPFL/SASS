...
public class FluorophoreGenerator {
    ...
    public static ArrayList<DefaultFluorophore> generateFluorophoresRandom(int n_fluos, Camera cam, FluorophoreProperties fluo) {
        ...
        ArrayList<DefaultFluorophore> result = new ArrayList<DefaultFluorophore>();
        double x; double y;
     ...
     */
    @Deprecated
    public static ArrayList<DefaultFluorophore> parseFluorophoresFromCsv(File file, Camera camera, FluorophoreProperties fluo, boolean rescale) throws FileNotFoundException, IOException {
        if (file==null) {
