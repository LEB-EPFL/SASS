...
public abstract class FluorophoreProperties {
     ...
     * @param x DefaultFluorophore x-position in pixels.
     * @param y DefaultFluorophore y-position in pixels.
     * @param z DefaultFluorophore z-position in pixels.
     * @return A new fluorophore object.
     */
    public abstract DefaultFluorophore newFluorophore(
